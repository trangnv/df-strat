...
def load_nft_vol(dir_path, basetoken_addr1, basetoken_addr2):
    ...
    nft_vol1 = nft_vol.loc[nft_vol["basetoken_addr"] == basetoken_addr1]
    nft_vol2 = nft_vol.loc[nft_vol["basetoken_addr"] == basetoken_addr2]
